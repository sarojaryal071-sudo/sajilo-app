...
import AdminProfessions from './AdminProfessions.jsx'
...
export default function AdminCategories() {
  ...
  const [activeTab, setActiveTab] = useState(0)   // 0 = Service Categories, 1 = Professional Configurations
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 20, overflowX: 'auto' }}>
        <button onClick={() => setActiveTab(0)} style={{
          ...
          background: activeTab === 0 ? 'var(--accent-blue)' : 'transparent',
          color: activeTab === 0 ? '#fff' : 'var(--text-secondary)',
        ...
        <button onClick={() => setActiveTab(1)} style={{
          padding: '10px 20px', borderRadius: 20, border: '1px solid var(--border)',
          background: activeTab === 1 ? 'var(--accent-blue)' : 'transparent',
      ...
      {activeTab === 0 ? (
        <>
          {/* ─── Service Categories Grid (existing) ─── */}
          ...
          {/* Modal (only for Service Categories tab) */}
          {showModal && (
            <div style={{
        ...
        /* ─── Professional Configurations Tab ─── */
        <AdminProfessions />
      )}
    </div>
  )
